...
function initCalender(monthData) {
	...
	$.each(monthData,
        ...
        classToAdd = "selectable";
			...
			userSelectedDay = value.date.day;
			userSelectedMonth = value.date.month;
			userSelectedYear = value.date.year;
		});
...
function dateClickHandler(elem) {
	...
	userSelectedDay = day1;
	userSelectedMonth = $(".month").html();
	userSelectedYear = $(".year").html();
	console.log('this can be clicked');
